@extends('irfan.blog.main')
@section('content')
<div class="image">
        <img src="{{ asset('irfan/th.jpeg') }}" alt="gambar anda tidak ada">
    </div>
    <marquee> Selamat Datang Di Profile Saya  </marquee>
            ...
            <tr>
                ...
                <td>
                    <table class="Me">
                        ...
                        <tr>
                            <td class="OIP">
                                <img src="{{ asset('irfan/th.jpeg') }}" alt="" class="cihuy">
                            </td>
                        </tr>
                        <tr>
                            <td>
